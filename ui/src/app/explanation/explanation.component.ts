...
import { SseClient, SseRequestOptions } from 'ngx-sse-client';
...
export class ExplanationComponent {
  ...
  getPromptBody(): string {
    ...
    Please use markdown format in your response.
    `;
  }
  ...
  ngOnInit(): void {
    ...
    const requestOptions: SseRequestOptions = {
      body: this.getPromptBody(),
    }
